    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('/')}}">Tìm Kiếm</a></li>
            </ol>
        </nav>

        <h3> Bạn đang tìm kiếm với từ khóa : {{$key}}</h3>
        @if($cout==0)
            <div class="row">
                <h2 style="height: 400px;margin-left: 470px">Không tìm thấy truyện</h2>
            </div>
        @else
            <div class="row">
